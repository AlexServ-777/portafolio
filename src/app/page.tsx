    ...
    <div className={`${styles.page} d-flex flex-column`}>
      ...
      <div style={{ marginLeft: '15%', marginRight: '15%' }}>
        <section ref={homeRef} className={`HOME d-flex justify-content-center align-items-center gap-5`} style={{ height: '100vh' }}>
          <div className="d-flex flex-column gap-3">
            ...
            <div className="d-flex gap-3">
              <Link href={'/cv_alex_gonzales.pdf'} download={'/cv_alex_gonzales.pdf'} className="btn btn-outline-info" >
                DESCARGAR CV
              </Link>
        ...
        <section ref={sobreRef} className="SobreMi d-flex justify-content-center flex-column" style={{ height: '100vh' }}>
          <h2 className="text-white">Sobre Mi <hr /></h2>
        ...
        <section ref={proyectosRef} className="Proyectos d-flex flex-column justify-content-center" style={{ height: '100vh' }}>
          <h2 className="text-white">PROYECTOS <hr /></h2>
          <div className={`row g-3 ${styles.proyectos}`}>
            <div className="col-6">
              <img src={'/empleosP.png'} onClick={() => window.open('https://jobget.vercel.app')} />
              ...
              <section className="d-flex justify-content-center gap-3 p-3">
                <Link href={'https://github.com/AlexServ-777/empleos-frontend.git'} target="_blank" className="btn btn-outline-info">CODIGO FRONTEND</Link>
                <Link href={'https://github.com/AlexServ-777/empleos-backend.git'} target="_blank" className="btn btn-outline-info">CODIGO BACKEND</Link>
              </section>
            </div>
            <div className="col-6">
              ...
              <section className="d-flex justify-content-center">
                <Link href={'https://github.com/AlexServ-777/portafolio.git'} target="_blank" className="btn btn-outline-info">IR AL CODIGO</Link>
              </section>
            </div>
            <div className="col-6">
